...
-   Eenvoudige grafieken en boxplots maken

-   Testen voor normaalverdeling\
...
Download **alle** Jamovi-gegevensbestanden van [GitHub](https://github.com/wdkeyzer/Jamovi/tree/main/00-Data-Files) en sla ze ergens op waar je er gemakkelijk bij kunt.
...
Klik op de variabele **Weight** in het linkervak en klik op de pijl om deze te verplaatsen naar het vak **Variables** aan de rechterkant. Klik vervolgens op de variabele **Gender** en verplaats deze met de pijl naar het vak **Split By**: ![](_imgs/01-13.png)
