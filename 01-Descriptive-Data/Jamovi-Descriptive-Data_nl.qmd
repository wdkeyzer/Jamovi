---
title: 'Beschrijvende statistiek en normaliteit'
lang: nl
toc: true
...
-   **Kennis** - Identificeer en benoem de belangrijkste componenten en functies van de Jamovi-omgeving.

-   **Toepassing** - Pas technieken toe om variabelen en cases in Jamovi te creëren en te onderzoeken, en interpreteer de basiskenmerken van deze data.

-   **Analyse** - Analyseer datasets door beschrijvende statistische methoden toe te passen in Jamovi, en trek conclusies uit de verkregen resultaten.

-   **Creatie** - Ontwerp en creëer eenvoudige grafieken en boxplots in Jamovi, gebruikmakend van de verzamelde gegevens om trends en patronen visueel weer te geven.

-   **Evaluatie** - Evalueer datasets op normaalverdeling in Jamovi, beoordeel de geschiktheid van de data voor bepaalde statistische testen en interpreteer de relevantie van de uitkomsten.
:::
...
::: callout-tip
[Q1](#a1){#q1}. Hoeveel kolommen met gegevens zijn er?

[Q2](#a2){#q2}. Hoeveel rijen gegevens zijn er?

[Q3](#a3){#q3}. Waarom een deelnemers-ID als er een recordnummer is?

[Q4](#a4){#q4}. Waarom hebben we hoe dan ook een deelnemers-ID nodig? Waarom gebruiken we niet gewoon de naam van de deelnemer?
:::
...
::: callout-tip
[Q5](#a5){#q5}. Hoeveel datatypes zijn er beschikbaar in Jamovi?
:::

Jamovi heeft vier hoofdtypen gegevens:

-   Nominaal
-   Ordinaal
-   Continu (gehele getallen en decimale getallen, ook wel bekend als Interval en Ratio)
-   ID
...
::: callout-tip
[Q6](#a6){#q6}. Waarom zou PartID van het type ID of Nominal zijn, ook al lijkt het een geordende lijst van getallen te zijn?
:::
...
::: callout-note
Gebruik het **File** menu van eerder om je werk op te slaan - klik op de drie gestapelde witte lijnen in de hoek en kies **Save** of **Save as**. Je kan ook de sneltoetsen **Ctrl + S** (Windows) of **Cmd + S** (Mac) gebruiken om op te slaan.
:::
...
Klik op de variabele **Weight** in het linkervak en klik op de pijl om deze te verplaatsen naar het vak **Variables** aan de rechterkant. Klik vervolgens op de variabele **Gender** en verplaats deze met de pijl naar het vak **Split By**: ![](imgs/01-13.png)
...
::: callout-tip
[Q7](#a7){#q7}. Wie is er gemiddeld zwaarder in deze dataset, mannen of vrouwen?

[Q8](#a8){#q8}. Hoeveel mannen en vrouwen zijn er? En hoe groot is onze totale steekproefomvang?
:::

Laten we nog wat meer van onze gegevens bekijken. Eerder zagen we dat we twee kolommen hadden, BIA1 en BIA2, waar we het lichaamsvetpercentage hebben gemeten met twee 'identieke' apparaten. Hier kunnen we deze twee velden kort bekijken om eventuele verschillen te vergelijken.
...
::: callout-tip
[Q9](#a9){#q9}. Zou je op basis van de beschrijvende gegevens voor de twee machines zeggen dat de machines 'dezelfde' resultaten laten zien?
:::
...
::: callout-tip
[Q10](#a10){#q10}. Hoeveel studenten hebben daadwerkelijk een cursusnaam opgegeven?

[Q11](#a11){#q11}. Welke cursus heeft het grootste percentage studenten?

[Q12](#a12){#q12}. Welk percentage studenten volgt Sport and Dance Therapy?
:::
...
::: callout-tip
[Q13](#a13){#q13}. Gebaseerd op de histogrammen, welk Geslacht heeft een grotere variabiliteit in gewicht? Waarom?
:::
...
::: callout-tip
[Q14](#a14){#q14}. Wat is op de boxplot bij benadering de waarde voor de lengte van de man en de lengte van de vrouw?
:::
...
-   Hoog meetniveau van de testvariabele
...
Laten we de verdeling van de lengtegegevens van mannen en vrouwen onderzoeken. Om de twee sets onafhankelijke gegevens te vergelijken, moeten we ervoor zorgen dat zowel de mannelijke als de vrouwelijke gegevens niet significant afwijken van een normale verdeling. *(Opmerking: het testen van gegevens met herhaalde metingen vereist een iets andere test, maar hier zullen we de normaalverdeling voor onafhankelijke steekproeven onderzoeken en later kijken naar afhankelijke gegevens)*
...
::: callout-tip
[Q15](#a15){#q15}. Welke test zou je uitvoeren?

[Q16](#a16){#q16}. Welke p-waarde voor de normaliteitstest krijg je voor de gewichtsgegevens van de groep vrouwen? Wat betekent deze p-waarde?
:::
...
-   Vrouwelijke scheefheid = -0,099
-   Vrouwelijke kurtosis = -0,380

::: callout-tip
[Q17](#a17){#q17}. Beschrijf op basis van de ruwe waarden voor scheefheid en kurtose de vorm van de verdeling van de mannelijke gegevens.
:::

Een vuistregel suggereert dat -1 tot +1 acceptabel is voor scheefheid en -2 tot +2 acceptabel is voor kurtosis. Merk op dat de scheefheid voor mannen buiten de -1 tot +1 valt, maar dat alle andere waarden ruim binnen hun bereik liggen. Strikt genomen zouden we kunnen zeggen dat de lengtegegevens van mannen niet normaal verdeeld zijn en een lichte positieve scheefheid vertonen (d.w.z. een opeenstapeling van gegevens aan de linkerkant).
...
::: callout-note
**Normaliteit bij herhaalde metingen:** Met gegevens van onafhankelijke steekproeven, of twee verschillende groepen, moet je de normaliteit van elke afzonderlijke groep controleren. Als je gepaarde metingen hebt, bijvoorbeeld als je groep een test uitvoert onder twee verschillende condities, dan test je niet op de normaliteit van elke groep, maar op de normaliteit van het *verschil* tussen de twee condities.
:::
...
Net als bij de normaliteitstest is er een statistische test en een vuistregel. Beginnend met de vuistregel, willen we ervoor zorgen dat de varianties van de twee steekproeven een factor minder dan 3 verschillen. Hoe dichter bij 1, hoe homogener de varianties van beide steekproeven zijn.
...
We kunnen deze varianties bekijken in Jamovi - nog steeds met **Height** uitgesplitst naar **Gender** geselecteerd, vink het selectievakje **variance** aan. Hierdoor worden de varianties voor mannelijke en vrouwelijke groepen weergegeven in onze tabel Descriptives in de resultatenviewer.
...
1,07 is ruim binnen onze vuistregel van 3, dus we kunnen homogeniteit van variantie *aannemen*. Maar laten we het ook testen. De statistische test die we hiervoor zullen gebruiken is **Levene's Test of Homogeneity**.
...
::: callout-tip
[Q18](#a18){#q18}. Wat is de Levene's test en *p* waarde en wat betekent dit?

[Q19](#a19){#q19}. Zou je een parametrische test uitvoeren op deze gegevens? En waarom?
:::
...
[A1](#q1){#a1}. In dit gegevensbestand staan 9 kolommen met gegevens: PartID, Age, Gender, Course, Weight, Height, BIA1, BIA2 en FitPercept.

[A2](#q2){#a2}. Er zijn 50 rijen met gegevens, oftewel 50 'cases' (eenheden). Gebruik PartID niet om het aantal records weer te geven.

[A3](#q3){#a3}. Ook al is er een rijnummer, dit identificeert geen specifieke eenheid uit de gegevens, alleen de volgorde van de rijen (of cases) die momenteel worden weergegeven. Met de PartId kan de gebruiker gemakkelijk een bepaalde case identificeren. Als je de gegevens sorteert of filtert, kunnen de rijnummers veranderen, maar PartId blijft consistent.

[A4](#q4){#a4}. Ten eerste zal de PartID uniek zijn, maar het maakt het ook mogelijk om de gegevens te anonimiseren.

[A5](#q5){#a5}. Jamovi heeft vier hoofdtypen gegevens: Nominaal, Ordinaal, Continu en ID. Continu is een combinatie van de gegevenstypen Interval en Ratio. ID is een uniek gegevenstype voor Jamovi, dat alleen wordt gebruikt voor deelnemers-ID-variabelen, dat vergelijkbaar is met een nominaal gegevenstype, maar zonder categorieniveaus of labels.

[A6](#q6){#a6}. Het veld is puur een 'naam' voor elk record, je kunt er niet uit afleiden dat er een volgorde is, of dat het ene voor of na het andere moet komen.

[A7](#q7){#a7}. Vrouwen zijn gemiddeld zwaarder. Gemiddelde massa vrouw = 78.3 kg, gemiddelde massa man = 64.2 kg.

[A8](#q8){#a8}. Er zijn 17 mannen en 32 vrouwen in de steekproef (+1 vrouw als je er zelf manueel 1 toegevoegd hebt). De totale steekproefomvang bedraagt 50 (+1 als je er zelf manueel 1 toegevoegd hebt).

[A9](#q9){#a9}. Het is moeilijk definitief te zeggen of de machines 'hetzelfde' laten zien. De beschrijvende informatie zou suggereren dat de waarden 'gemiddeld' hetzelfde zijn, maar afzonderlijke machines binnen de steekproef zouden heel verschillende resultaten kunnen laten zien, bijv. machine 1 geeft 15% en 25% voor twee deelnemers, maar machine 2 geeft 25% en 15% voor dezelfde twee. Gemiddeld' zouden beide machines 20% aangeven. Het feit dat getallen op elkaar 'lijken' betekent niet dat ze statistisch gezien hetzelfde zijn.

[A10](#q10){#a10}. 49 studenten hebben een cursus opgegeven, voor 1 student ontbreekt de cursus (+1 als je er zelf manueel 1 toegevoegd hebt).

[A11](#q11){#a11}. Sport Therapy, met 55,1%.

[A12](#q12){#a12}. 14,3% van de studenten volgt Sport and Dance Therapy.

[A13](#q13){#a13}. Uit de grafiek blijkt dat vrouwen variabeler zijn en zich links en rechts van de mannen in de grafiek uitstrekken. De standaarddeviatie is ook groter voor vrouwen (17,32 kg) vergeleken met mannen (13,84 kg).

[A14](#q14){#a14}. In de boxplot is de mediaan de dikke zwarte lijn in het midden van elk vak. De geschatte waarde voor de mediane lengte bij mannen is 166 cm en bij vrouwen 175 cm.

[A15](#q15){#a15}. Voor een normaliteitstest zou je de Shapiro-Wilk test uitvoeren.

[A16](#q16){#a16}. Voor vrouwen is Shapiro-Wilk *p* = 0,210 (0,402 als je manueel een vrouw toegevoegd hebt met gewicht 41 kg). Dit is vergelijkbaar met de *p*-waarde voor mannen. Een niet-significante waarde suggereert dat de steekproefverdeling voor het gewicht van vrouwen niet significant verschilt van een normale verdeling, zodat aan een van de aannames voor het uitvoeren van parametrische tests is voldaan.

[A17](#q17){#a17}. De positieve scheefheidswaarde (1,03) suggereert dat de grafiek een iets langere rechterstaart heeft, en de positieve kurtosiswaarde (0,959) suggereert dat de curve iets spitser is dan een normale verdeling (ook wel leptokurtisch genoemd).

[A18](#q18){#a18}. De Levene's test: F = 0707, p = 0,405. Dit betekent dat de varianties niet significant verschillen, dus we kunnen homogeniteit van variantie aannemen.

[A19](#q19){#a19}. Ja, we hebben voldaan aan de vier voorwaarden, 1. Het zijn gegevens van hoog meetniveau, 2. Ze zijn willekeurig toegewezen/geselecteerd, 3. Ze zijn normaal verdeeld, en 4. De varianties zijn gelijk.
:::
