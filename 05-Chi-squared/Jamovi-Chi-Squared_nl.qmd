...
Tot nu toe hebben we vooral gekeken naar beschrijvende statistieken van continue variabelen (bijvoorbeeld een getal, zoals lichaamsgewicht). Soms willen we echter categorische variabelen beschrijven en voorspellen, met andere woorden, we willen voorspellen in welke categorie een entiteit valt. We willen bijvoorbeeld voorspellen welke cursus een student volgt of of iemand zwanger is. In beide gevallen is er een binaire keuze: je volgt de cursus of niet, je bent zwanger of niet. De Chi-kwadraattest onderzoekt dan of er een **verband** is tussen twee (of meer) **categorische** variabelen, met de hypotheses:
...
-   **Begrip** - Leg uit en illustreer de verschillen tussen typen Chi-Kwadraattoetsen, zoals onafhankelijkheidstoetsen en aanpassingstoetsen.
...
Zo eenvoudig is het om onze contingentietabel in de resultaten te zien - met de genderlabels Man en Vrouw als rijen en de cursus-ID's als kolommen. De getallen in elke cel vertellen ons dus hoeveel gevallen er in elke combinatie van geslacht en cursusID-groep zitten.
...
-   Expected (verwacht): dit is het aantal dat we *verwachten* in elke cel te hebben als de aantallen *gelijk* verdeeld waren. We berekenen dit als de verwachte waarde over de algemeen totaal. Bijvoorbeeld, het verwachte aantal mannelijke sporttherapeuten = (totaal Sports Therapy \* totaal mannen) / (totaal studenten) = (15\*12)/28 = 6,4, d.w.z. in deze steekproef zouden we verwachten dat er 6,4 mannelijke studenten sporttherapie zouden studeren. Zo controleren we ook onze voorwaarde over de verwachte frequentie.
...
Hier zien we dat de *p* waarde groter is dan 0,05, dus we accepteren de nulhypothese dat er geen interactie / associatie / relatie (je kunt er op verschillende manieren naar verwijzen, maar ze betekenen hetzelfde) is tussen cursus en geslacht. Dat wil zeggen dat je niet kunt *voorspellen* welke cursus een student waarschijnlijk zal volgen als je alleen zijn geslacht weet.  
...
[Q9](#a9){#q9}. Hoeveel deelnemers zijn er in totaal in deze dataset?

[Q10](#a10){#q10}. Hoeveel deelnemers zijn er opgenomen in de analyse?

[Q11](#a11){#q11}. Hoeveel mannen zitten er in de analyse?

[Q12](#a12){#q12}. Hoeveel geobserveerde mannen zijn er in de cursu Sports Therapy en hoeveel verwachte?

[Q13](#a13){#q13}. Wat is de berekening voor de verwachte vrouwen in Sport and Dans Therapy? 

:::

Tot slot moeten we de resultaten van de chi-kwadraattoets kunnen rapporteren. Nu we weten dat de test significant is, kunnen we kijken naar de waarden binnen de cellen voor elke groep en enkele conclusies trekken over wat de getallen betekenen. Dus voor deze test kunnen we schrijven:

::: {.callout-info}
Er was een significant verband tussen het type klas en het geslacht, χ^2^(1) = 3,89, *p* = 0,049. Geslacht lijkt te bepalen voor welke cursus een student zich inschrijft. Mannen schrijven zich vaker in voor Sports Therapy en vrouwen voor Sport and Dans Therapy.
:::
...
De odds ratio is een kansverhouding doe ons vertelt hoe groot de kans is dat een enkele deelnemer uit een van beide **rijen-groepen** in de **eerste kolom-groep** zit. Dat klinkt misschien een beetje verwarrend, dus laten we het even doornemen. Eerst vink je in het menu **Statisticsn** onder **Comparative Measures (2x2 ony)** het selectievakje **Odds Ratio** aan en verwijder je het vinkje bij **Confidence intervals** als dit is geselecteerd om het duidelijker te maken. De oddsratiotabel verschijnt onder onze χ^2^ tabel in de resultaten.
...
**Ods ratio = ( a x d ) / ( c x b )**

Door deze berekening wordt cel a - man en Sports Therapy - de belangrijkste cel waarmee we vergelijken. We kunnen onze oddsratio van 4,4 dus lezen als: "mannen hadden 4,4 keer zoveel kans als vrouwen om de cursus Sports Therapy te kiezen in plaats van Sport and Dans Therapy".

Dit kan op het eerste gezicht vreemd lijken, want als we kijken naar onze ruwe waargenomen cijfers is '10 mannelijke sporttherapeuten' niet 4 keer zo groot als '5 mannelijke sport- en danstherapeuten'. Maar dit komt omdat de odds ratio geen directe vergelijking is van onze cijfers op deze manier. Odds kunnen zeker een beetje verwarrend zijn, maar in het kort wordt de odds ratio gedefinieerd als:
...
[Q16](#a16){#q16}. Hoeveel mannen in de totale steekproef?
...
[A1](#q1){#a1}. Geslacht is een nominaal gegeven, wijs een woord toe als label aan een kenmerk. In dit geval bevatten onze gegevens alleen 'man' en 'vrouw'.
...
[A8](#q8){#a8}. Van de cursus *Sports Therapy* was 53,5% vrouw.
...
-   (16 \* 16) / 31 = 8.25, afgerond naar 8.3 verwachte vrouwen op Sport and Dance Therapy.
